        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a type="button" class="btn btn-primary" href="{{url('admin/pengajuan/create')}}"><i class="fa fa-plus"> Pengajuan Baru</i></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <div class="btn-group-vertical">
                        <a type="button" class="btn btn-default" href="{{url('admin/pengajuan/'.$r->id_rtlh)}}"><i class="fa fa-eye"> Detail</i></a>
                        {!! Form::open(array('url' => 'admin/pengajuan/'.$r->id_rtlh, 'method' => 'delete')) !!}
