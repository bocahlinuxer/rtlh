...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{url('adminverifikasi/verifikasi/'.$idrtlh)}}">Foto RTLH</a></li>
  ...
  <section class="content">
    <!-- Default box -->
    {!! Form::open(array('url' => url('adminverifikasi/verifikasi/'.$idrtlh.'/fotortlh'), 'role' => 'form', 'method' => 'POST', 'enctype' => 'multipart/form-data')) !!}
