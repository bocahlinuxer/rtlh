...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{url('adminperbekel/pengajuan')}}">Pengajuan RTLH</a></li>
  ...
  <section class="content">
    <!-- Default box -->
    {!! Form::open(array('url' => url('adminperbekel/pengajuan/'.$rtlh->id_rtlh), 'role' => 'form', 'method' => 'PUT')) !!}
      <div class="box box-success" style="width: 50%">
        ...
        <div class="box-body">
          ...
          <div class="form-group {{ $errors->has('latitude') ? ' has-error' : '' }}">
            ...
            <input type="text" class="form-control" id="latitude" name="latitude" value="{{$rtlh->latitude}}">
          ...
          <div class="form-group {{ $errors->has('longitude') ? ' has-error' : '' }}">
            ...
            <input type="text" class="form-control" id="longitude" name="longitude"  value="{{$rtlh->longitude}}">
        ...
        <div class="box-footer">
          <a type="button" class="btn btn-danger" href="{{url('adminperbekel/pengajuan/'.$rtlh->id_rtlh)}}">Kembali</a>
