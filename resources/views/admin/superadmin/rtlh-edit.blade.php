...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{url('superadmin/rtlh')}}">RTLH</a></li>
  ...
  <section class="content">
    <!-- Default box -->
    {!! Form::open(array('url' => url('superadmin/rtlh/'.$rtlh->id_rtlh), 'role' => 'form', 'method' => 'PUT')) !!}
      <div class="box box-success" style="width: 50%">
        ...
        <div class="box-footer">
          <a type="button" class="btn btn-danger" href="{{url('superadmin/rtlh/'.$rtlh->id_rtlh)}}">Kembali</a>
