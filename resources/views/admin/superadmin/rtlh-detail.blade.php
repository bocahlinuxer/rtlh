...
<link rel="stylesheet" href="{{asset('assets/plugins/datatables/dataTables.bootstrap.css')}}">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Detail Rumah Tidak Layak Huni <a type="button" class="btn btn-primary pull-right" href="{{url('superadmin/rtlh/'.$rtlh->id_rtlh.'/edit')}}"><i class="fa fa-edit"> Ubah Data</i></a>
      </h1>
    </section>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a type="button" class="btn btn-primary pull-right" style="margin-top: -5px" href="{{url('superadmin/rtlh/'.$rtlh->id_rtlh.'/fotortlh/create')}}"><i class="fa fa-plus"> Tambah Foto</i></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <div class="btn-group-vertical">
                        <a type="button" class="btn btn-default" href="{{url('superadmin/rtlh/'.$rtlh->id_rtlh.'/fotortlh/'.$u->id_fotortlh.'/edit')}}"><i class="fa fa-edit"> Ubah</i></a>
                        {!! Form::open(array('url' => 'superadmin/rtlh/'.$rtlh->id_rtlh.'/fotortlh/'.$u->id_fotortlh, 'method' => 'delete')) !!}
