        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a type="button" class="btn btn-primary" href="{{url('superadmin/pekerjaan/create')}}"><i class="fa fa-plus"> Tambah Baru</i></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <div class="btn-group-vertical">
                        <a type="button" class="btn btn-default" href="{{url('superadmin/pekerjaan/'.$u->id_pekerjaan.'/edit')}}"><i class="fa fa-edit"> Ubah</i></a>
                        {!! Form::open(array('url' => 'superadmin/pekerjaan/'.$u->id_pekerjaan, 'method' => 'delete')) !!}
