      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Daftar Pekerjaan</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Admin Perbekel</span>
              <span class="info-box-number">{{$adminperbekel}}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Admin Verifikasi</span>
              <span class="info-box-number">{{$adminverifikasi}}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
