...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Tambah Pengajuan Rumah Tidak Layak Huni
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li><a href="{{url('pengajuan')}}">Pengajuan RTLH</a></li>
  ...
  <section class="content">
    <!-- Default box -->
    {!! Form::open(array('url' => url('pengajuan'), 'role' => 'form', 'method' => 'POST')) !!}
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="desa" name="desa">
              ...
              <optgroup label="{{$kec->kecamatan}}">
                ...
                <option value="{{$des->id_desa}}">{{$des->desa}}</option>
                @endforeach
              </optgroup>
              @endforeach
            </select>
