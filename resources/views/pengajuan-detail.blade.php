...
<link rel="stylesheet" href="{{asset('assets/plugins/datatables/dataTables.bootstrap.css')}}">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Detail Pengajuan Rumah Tidak Layak Huni <a type="button" class="btn btn-primary pull-right" href="{{url('pengajuan/'.$rtlh->id_rtlh.'/edit')}}"><i class="fa fa-edit"> Ubah Pengajuan</i></a>
      </h1>
    </section>
