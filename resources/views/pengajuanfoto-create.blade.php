...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Tambah Foto Pengajuan RTLH
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li><a href="{{url('pengajuan/'.$idrtlh)}}">Foto Pengajuan RTLH</a></li>
  ...
  <section class="content">
    <!-- Default box -->
    {!! Form::open(array('url' => url('pengajuan/'.$idrtlh.'/fotortlh'), 'role' => 'form', 'method' => 'POST', 'enctype' => 'multipart/form-data')) !!}
      <div class="box box-success" style="width: 50%">
        ...
        <div class="box-footer">
          <a type="button" class="btn btn-danger" href="{{url('pengajuan/'.$idrtlh)}}">Kembali</a>
