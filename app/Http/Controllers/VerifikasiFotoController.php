...
class VerifikasiFotoController extends Controller
{
    /**
    ...
    {
        return view('admin.verifikasi.verifikasi-foto-create')->with('idrtlh', $idrtlh);
    }
    ...
    public function store($idrtlh, Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect('adminverifikasi/verifikasi/'.$idrtlh.'/fotortlh/create')
        ...
        return redirect('adminverifikasi/verifikasi/'.$idrtlh);
    }
    ...
    {
        return view('admin.verifikasi.verifikasi-foto-edit')->with(array(
            'idrtlh' => $idrtlh,
            'id' => $id
            ));
    }
    ...
    public function update($idrtlh, Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            return redirect('adminverifikasi/verifikasi/'.$idrtlh.'/fotortlh/'.$id.'/edit')
                        ->withErrors($validator)
                        ->withInput();
        }
